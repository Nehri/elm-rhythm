...
Elm.Main.make = function (_elm) {
   ...
   var Good = {ctor: "Good"};
   var clickPeak = F3(function (current,start,peak) {
      var timeDistance = start + peak.timeDelta - current;
      return _U.cmp(timeDistance,-75) > 0 && _U.cmp(timeDistance,
      30) < 0 ? _U.update(peak,
      {hitType: Perfect}) : _U.cmp(timeDistance,
      -175) > 0 && _U.cmp(timeDistance,75) < 0 ? _U.update(peak,
      {hitType: Good}) : _U.update(peak,
      {penaltyCount: peak.penaltyCount + 1});
   });
   ...
   var update = F2(function (inputSig,_p42) {
      var _p43 = _p42;
      var _p52 = _p43._4;
      var _p51 = _p43._1;
      var _p50 = _p43._0;
      ...
      var _p44 = inputSig;
      switch (_p44.ctor)
      {case "InitData": var _p45 = _p44._0;
           var speed = 0.5 * $Basics.toFloat(_p45.bpm) / 60000.0;
           var line$ = _U.update(_p49,{speed: speed});
           return {ctor: "_Tuple5"
                  ,_0: toPeakObjects(_p45)
                  ,_1: _p51
                  ,_2: line$
                  ,_3: _p45.bpm
                  ,_4: _p45.start};
         case "Click": if (_p44._0._1) {
                 var _p46 = _p50;
                 if (_p46.ctor === "[]") {
                       return {ctor: "_Tuple5"
                              ,_0: _p50
                              ,_1: _U.update(_p51,{penaltyCount: _p51.penaltyCount + 1})
                              ,_2: _p49
                              ,_3: _p48
                              ,_4: _p52};
                    } else {
                       return {ctor: "_Tuple5"
                              ,_0: A2($List._op["::"],
                              A3(clickPeak,_p44._0._0,_p52,_p46._0),
                              _p46._1)
                              ,_1: _p51
                              ,_2: _p49
                              ,_3: _p48
                            ...
                            ,_3: _p48
                            ,_4: _p52};
         default: var line$ = A2(updateLine,_p44._0._1,_p49);
           var _p47 = A2(updatePeaks,
           _p44._0._0,
           {ctor: "_Tuple5",_0: _p50,_1: _p51,_2: _p49,_3: _p48,_4: _p52});
           var ps$ = _p47._0;
           var score$ = _p47._1;
           return {ctor: "_Tuple5"
                  ,_0: ps$
