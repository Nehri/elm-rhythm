...
Elm.Main.make = function (_elm) {
   ...
   var clickPeaks = F4(function (current,start,b,peaks) {
      ...
      if (_p6.ctor === "[]") {
            ...
            75) < 0 ? A2($List._op["::"],
            _U.update(_p7,{clicked: b}),
            A4(clickPeaks,current,start,b,_p6._1)) : peaks;
         }
   });
   ...
   var drawPeak = F5(function (_p8,peak,futurePos,timeDistance,r) {
      var _p9 = _p8;
      var _p10 = _p9._1;
   ...
   var update = F2(function (inputSig,_p11) {
      update: while (true) {
         var _p12 = _p11;
         var _p23 = _p12._5;
         var _p22 = _p12._0;
         ...
         var _p13 = inputSig;
         switch (_p13.ctor)
         {case "InitData": var _p14 = _p13._0;
              return {ctor: "_Tuple6"
                     ,_0: toPeakObjects(_p14)
                     ,_1: 0
                     ,_2: 0
                     ,_3: _p20
                     ,_4: _p14.bpm
            ...
            case "Click": return {ctor: "_Tuple6"
                                 ,_0: A4(clickPeaks,_p13._0._0,_p23,_p13._0._1,_p22)
                                 ,_1: _p19
                                 ,_2: _p21
                                 ,_3: _p20
                                 ,_4: _p18
                                 ,_5: _p23};
            default: var _p15 = _p22;
              if (_p15.ctor === "[]") {
                    return {ctor: "_Tuple6"
                           ,_0: _U.list([])
                           ,_1: _p19
                    ...
                    var _p17 = _p15._1;
                    var _p16 = _p15._0;
                    var timeDistance = _p23 + _p16.timeDelta * 1000 - _p13._0._0;
                    var line$ = A2(updateLine,_p13._0._1,_p20);
                    if (_U.cmp(timeDistance,-300) < 0) if (_p16.clicked) {
                             var _v7 = inputSig,
                             _v8 = {ctor: "_Tuple6"
                                   ,_0: _p17
                                   ,_1: _p19 + 1
   ...
   var drawPeaks = F3(function (_p25,current,_p24) {
      drawPeaks: while (true) {
         ...
         if (_p28.ctor === "[]") {
               ...
               var _p30 = _p28._1;
               var _p29 = _p28._0;
               var timeDistance = _p35 + _p29.timeDelta * 1000 - current;
               if (_U.cmp(timeDistance,-300) < 0) {
                     var _v14 = {ctor: "_Tuple2",_0: _p37,_1: _p36},
                     _v15 = current,
                     _v16 = {ctor: "_Tuple6"
                            ,_0: _p30
                            ,_1: _p32
                     ...
                     continue drawPeaks;
                        ...
                        var futurePos = A2(updateLine,timeDistance,_p33);
                        return A2($List._op["::"],
                        A5(drawPeak,
   ...
   var view = F3(function (_p39,rt,_p38) {
      var _p40 = _p39;
      var _p47 = _p40._0;
      var _p46 = _p40._1;
      var _p41 = _p38;
      ...
      var _p44 = _p41._1._3;
      var _p43 = _p41._1._1;
      var _p42 = {ctor: "_Tuple2",_0: _p47,_1: _p46 - 150};
      var w$ = _p42._0;
      var h$ = _p42._1;
      ...
      linePosition({ctor: "_Tuple2"
                   ,_0: $Basics.toFloat(_p47)
                   ,_1: _p44.height * $Basics.toFloat(h$ / 2 | 0)}),
      A2($List._op["::"],
      A3(drawScore,
      {ctor: "_Tuple2"
      ,_0: $Basics.toFloat(_p47)
      ,_1: $Basics.toFloat(_p46)},
      _p43,
      _p45),
      A2($List.append,
      A3(drawPeaks,
