...
Elm.Main.make = function (_elm) {
   ...
   var drawBackground = F2(function (_p2,rt) {
      ...
      return _U.list([A2($Graphics$Collage.moveX,
                     ...
                     A4($Color.rgba,0,71,65,0.9),
                     A2($Graphics$Collage.rect,
                     $Basics.toFloat(_p4),
                     $Basics.toFloat(_p3._1))))]);
   });
   var linePosition = function (_p5) {
      var _p6 = _p5;
      var _p8 = _p6._0;
      var _p7 = _p6._1;
   ...
   var updatePeaks = F2(function (current,_p9) {
      updatePeaks: while (true) {
         ...
         if (_p11.ctor === "[]") {
               ...
               var _p14 = _p11._1;
               var _p13 = _p11._0;
               var timeDistance = _p19 + _p13.timeDelta - current;
               if (_U.cmp(timeDistance,-300) < 0) {
                     var _p12 = _p13.hitType;
                     switch (_p12.ctor)
                     {case "Miss": var score$ = _U.update(_p18,
                          {missCount: _p18.missCount + 1
                          ,penaltyCount: _p18.penaltyCount + _p13.penaltyCount});
                          var _v6 = current,
                          _v7 = {ctor: "_Tuple5"
                                ,_0: _p14
                                ,_1: score$
                        ...
                        case "Good": var score$ = _U.update(_p18,
                          {goodCount: _p18.goodCount + 1
                          ,penaltyCount: _p18.penaltyCount + _p13.penaltyCount});
                          var _v8 = current,
                          _v9 = {ctor: "_Tuple5"
                                ,_0: _p14
                          ...
                          _p9 = _v9;
                          continue updatePeaks;
                        default: var score$ = _U.update(_p18,
                          {perfectCount: _p18.perfectCount + 1
                          ,penaltyCount: _p18.penaltyCount + _p13.penaltyCount});
                          var _v10 = current,
                          _v11 = {ctor: "_Tuple5"
                                 ,_0: _p14
                          ...
                          _p9 = _v11;
                          continue updatePeaks;}
                  } else return {ctor: "_Tuple2",_0: _p17,_1: _p18};
            }
      }
   });
   ...
   var Good = {ctor: "Good"};
   var drawPeak = F5(function (_p20,peak,line,timeDistance,r) {
      var _p21 = _p20;
      var _p22 = _p21._1;
   ...
   var drawPeaks = F3(function (_p24,current,_p23) {
      drawPeaks: while (true) {
         ...
         if (_p27.ctor === "[]") {
               ...
               var _p29 = _p27._1;
               var _p28 = _p27._0;
               var timeDistance = _p33 + _p28.timeDelta - current;
               if (_U.cmp(timeDistance,-300) < 0) {
                     var _v16 = {ctor: "_Tuple2",_0: _p35,_1: _p34},
                     _v17 = current,
                     _v18 = {ctor: "_Tuple5"
                            ,_0: _p29
                            ,_1: _p32
   ...
   var view = F3(function (_p37,rt,_p36) {
      var _p38 = _p37;
      var _p44 = _p38._0;
      var _p43 = _p38._1;
      var _p39 = _p36;
      var _p42 = _p39._1._1;
      var _p41 = _p39._1._2;
      var _p40 = {ctor: "_Tuple2",_0: _p44,_1: _p43 - 150};
      var w$ = _p40._0;
      var h$ = _p40._1;
      ...
      linePosition({ctor: "_Tuple2"
                   ,_0: $Basics.toFloat(_p44)
                   ,_1: _p41.height * $Basics.toFloat(h$ / 2 | 0)}),
      A2($List._op["::"],
      A2(drawScore,
      {ctor: "_Tuple2"
      ,_0: $Basics.toFloat(_p44)
      ,_1: $Basics.toFloat(_p43)},
      _p42),
      A2($List.append,
      A3(drawPeaks,
      ...
      ,_3: _p39._1._3
      ,_4: _p39._1._4}),
      A2(drawBackground,{ctor: "_Tuple2",_0: _p44,_1: _p43},rt)))));
   });
   var Miss = {ctor: "Miss"};
   ...
   var clickPeaks = F3(function (current,start,peaks) {
      ...
      if (_p45.ctor === "[]") {
            ...
            var _p47 = _p45._1;
            var _p46 = _p45._0;
            if (_U.eq(_p46.hitType,Miss)) {
                  var timeDistance = start + _p46.timeDelta - current;
                  return _U.cmp(timeDistance,-75) > 0 && _U.cmp(timeDistance,
                  30) < 0 ? A2($List._op["::"],
                  _U.update(_p46,{hitType: Perfect}),
                  _p47) : _U.cmp(timeDistance,-175) > 0 && _U.cmp(timeDistance,
                  75) < 0 ? A2($List._op["::"],
                  _U.update(_p46,{hitType: Good}),
                  _p47) : A2($List._op["::"],
                  _U.update(_p46,{penaltyCount: _p46.penaltyCount + 1}),
                  _p47);
               } else return A2($List._op["::"],
               _p46,
               A3(clickPeaks,current,start,_p47));
         }
   });
   var update = F2(function (inputSig,_p48) {
      var _p49 = _p48;
      var _p58 = _p49._4;
      var _p57 = _p49._1;
      var _p56 = _p49._0;
      ...
      var _p50 = inputSig;
      switch (_p50.ctor)
      {case "InitData": var _p51 = _p50._0;
           var speed = 0.5 * $Basics.toFloat(_p51.bpm) / 60000.0;
           var line$ = _U.update(_p55,{speed: speed});
           return {ctor: "_Tuple5"
                  ,_0: toPeakObjects(_p51)
                  ,_1: _p57
                  ,_2: line$
                  ,_3: _p51.bpm
                  ,_4: _p51.start};
         case "Click": if (_p50._0._1) {
                 var _p52 = _p56;
                 if (_p52.ctor === "[]") {
                       return {ctor: "_Tuple5"
                              ,_0: _p56
                       ...
                       return {ctor: "_Tuple5"
                              ,_0: A3(clickPeaks,_p50._0._0,_p58,_p56)
                              ,_1: _p57
                              ,_2: _p55
                              ,_3: _p54
                              ,_4: _p58};
                            ...
                            ,_3: _p54
                            ,_4: _p58};
         default: var line$ = A2(updateLine,_p50._0._1,_p55);
           var _p53 = A2(updatePeaks,
           _p50._0._0,
           {ctor: "_Tuple5",_0: _p56,_1: _p57,_2: _p55,_3: _p54,_4: _p58});
           var ps$ = _p53._0;
           var score$ = _p53._1;
           return {ctor: "_Tuple5"
                  ,_0: ps$
