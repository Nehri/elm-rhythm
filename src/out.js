...
Elm.Main.make = function (_elm) {
   ...
   var clickPeaks = F2(function (current,_p46) {
      var _p47 = _p46;
      var _p54 = _p47._4;
      var _p53 = _p47._1;
      var _p52 = _p47._0;
      ...
      if (_p48.ctor === "[]") {
            return {ctor: "_Tuple2"
                   ,_0: _p52
                   ,_1: _U.update(_p53,{penaltyCount: _p53.penaltyCount + 1})};
         } else {
            var _p51 = _p48._1;
            var _p50 = _p48._0;
            if (_U.eq(_p50.hitType,Miss)) {
                  var timeDistance = _p54 + _p50.timeDelta - current;
                  return _U.cmp(timeDistance,-75) > 0 && _U.cmp(timeDistance,
                  30) < 0 ? {ctor: "_Tuple2"
                            ,_0: A2($List._op["::"],_U.update(_p50,{hitType: Perfect}),_p51)
                            ,_1: _U.update(_p53,
                            {perfectCount: _p53.perfectCount + 1})} : _U.cmp(timeDistance,
                  -175) > 0 && _U.cmp(timeDistance,75) < 0 ? {ctor: "_Tuple2"
                                                             ,_0: A2($List._op["::"],_U.update(_p50,{hitType: Perfect}),_p51)
                                                             ,_1: _U.update(_p53,
                                                             {goodCount: _p53.perfectCount + 1})} : {ctor: "_Tuple2"
                                                                                                    ,_0: _p52
                                                                                                    ,_1: _U.update(_p53,{penaltyCount: _p53.penaltyCount + 1})};
               } else {
                  var _p49 = A2(clickPeaks,
                  current,
                  {ctor: "_Tuple5"
                  ,_0: _p51
                  ,_1: _p53
   ...
   var initState = {ctor: "_Tuple5"
                   ...
                   ,_3: 0
                   ,_4: 0};
   var update = F2(function (inputSig,_p55) {
      var _p56 = _p55;
      var _p65 = _p56._4;
      var _p64 = _p56._1;
      var _p63 = _p56._0;
      ...
      var _p57 = inputSig;
      switch (_p57.ctor)
      {case "InitData": var _p58 = _p57._0;
           var speed = 0.5 * $Basics.toFloat(_p58.bpm) / 60000.0;
           var line$ = _U.update(_p62,{speed: speed});
           return {ctor: "_Tuple5"
                  ,_0: toPeakObjects(_p58)
                  ,_1: initScore
                  ,_2: line$
                  ,_3: _p58.bpm
                  ,_4: _p58.start};
         case "Click": if (_p57._0._1) {
                 var _p59 = A2(clickPeaks,
                 _p57._0._0,
                 {ctor: "_Tuple5",_0: _p63,_1: _p64,_2: _p62,_3: _p61,_4: _p65});
                 var peaks$ = _p59._0;
                 var score$ = _p59._1;
                 return {ctor: "_Tuple5"
                        ,_0: peaks$
                        ...
                        ,_4: _p65};
                            ...
                            ,_3: _p61
                            ,_4: _p65};
         default: var line$ = A2(updateLine,_p57._0._1,_p62);
           var _p60 = A2(updatePeaks,
           _p57._0._0,
           {ctor: "_Tuple5",_0: _p63,_1: _p64,_2: _p62,_3: _p61,_4: _p65});
           var ps$ = _p60._0;
           var score$ = _p60._1;
