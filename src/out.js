...
Elm.Main.make = function (_elm) {
   ...
   var drawScore = F2(function (_p0,score) {
      var _p1 = _p0;
      var mC = score.missCount;
      var gC = score.goodCount;
      var pC = score.perfectCount;
   ...
   var updatePeaks = F2(function (current,_p10) {
      updatePeaks: while (true) {
         ...
         if (_p12.ctor === "[]") {
               ...
               var _p15 = _p12._1;
               var _p14 = _p12._0;
               var timeDistance = _p20 + _p14.timeDelta - current;
               if (_U.cmp(timeDistance,-300) < 0) {
                     var _p13 = _p14.hitType;
                     switch (_p13.ctor)
                     {case "Miss": var score$ = _U.update(_p19,
                          {missCount: _p19.missCount + 1
                          ,penaltyCount: _p19.penaltyCount + _p14.penaltyCount});
                          var _v6 = current,
                          _v7 = {ctor: "_Tuple5"
                                ,_0: _p15
                                ,_1: score$
                        ...
                        case "Good": var score$ = _U.update(_p19,
                          {goodCount: _p19.goodCount + 1
                          ,penaltyCount: _p19.penaltyCount + _p14.penaltyCount});
                          var _v8 = current,
                          _v9 = {ctor: "_Tuple5"
                                ,_0: _p15
                          ...
                          _p10 = _v9;
                          continue updatePeaks;
                        default: var score$ = _U.update(_p19,
                          {perfectCount: _p19.perfectCount + 1
                          ,penaltyCount: _p19.penaltyCount + _p14.penaltyCount});
                          var _v10 = current,
                          _v11 = {ctor: "_Tuple5"
                                 ,_0: _p15
                          ...
                          _p10 = _v11;
                          continue updatePeaks;}
                  } else return {ctor: "_Tuple2",_0: _p18,_1: _p19};
            }
      }
   });
   ...
   var ScoreObject = F4(function (a,b,c,d) {
      return {missCount: a
             ,goodCount: b
             ,perfectCount: c
             ,penaltyCount: d};
   ...
   var PeakObject = F3(function (a,b,c) {
      return {timeDelta: a,hitType: b,penaltyCount: c};
   });
   var Perfect = {ctor: "Perfect"};
   var Good = {ctor: "Good"};
   var drawPeak = F5(function (_p21,peak,line,timeDistance,r) {
      var _p22 = _p21;
      var _p23 = _p22._1;
   ...
   var drawPeaks = F3(function (_p25,current,_p24) {
      drawPeaks: while (true) {
         ...
         if (_p28.ctor === "[]") {
               ...
               var _p30 = _p28._1;
               var _p29 = _p28._0;
               var timeDistance = _p34 + _p29.timeDelta - current;
               if (_U.cmp(timeDistance,-300) < 0) {
                     var _v16 = {ctor: "_Tuple2",_0: _p36,_1: _p35},
                     _v17 = current,
                     _v18 = {ctor: "_Tuple5"
                            ,_0: _p30
                            ,_1: _p33
   ...
   var view = F3(function (_p38,rt,_p37) {
      var _p39 = _p38;
      var _p45 = _p39._0;
      var _p44 = _p39._1;
      var _p40 = _p37;
      var _p43 = _p40._1._1;
      var _p42 = _p40._1._2;
      var _p41 = {ctor: "_Tuple2",_0: _p45,_1: _p44 - 150};
      var w$ = _p41._0;
      var h$ = _p41._1;
      ...
      linePosition({ctor: "_Tuple2"
                   ...
                   ,_1: _p42.height * $Basics.toFloat(h$ / 2 | 0)}),
      A2($List._op["::"],
      A2(drawScore,
      {ctor: "_Tuple2"
      ,_0: $Basics.toFloat(_p45)
      ...
      ,_3: _p40._1._3
      ,_4: _p40._1._4}),
      A2(drawBackground,{ctor: "_Tuple2",_0: _p45,_1: _p44},rt)))));
   });
   var Miss = {ctor: "Miss"};
   var toPeakObjects = function (data) {
      return A2($List.map,
      function (time) {
         return {timeDelta: time * 1000
                ,hitType: Miss
                ,penaltyCount: 0};
      },
      data.peaks);
   };
   var clickPeaks = F3(function (current,start,peaks) {
      var _p46 = peaks;
      if (_p46.ctor === "[]") {
            return _U.list([]);
         } else {
            var _p48 = _p46._1;
            var _p47 = _p46._0;
            if (_U.eq(_p47.hitType,Miss)) {
                  var timeDistance = start + _p47.timeDelta - current;
                  return _U.cmp(timeDistance,-75) > 0 && _U.cmp(timeDistance,
                  30) < 0 ? A2($List._op["::"],
                  _U.update(_p47,{hitType: Perfect}),
                  _p48) : _U.cmp(timeDistance,-175) > 0 && _U.cmp(timeDistance,
                  75) < 0 ? A2($List._op["::"],
                  _U.update(_p47,{hitType: Good}),
                  _p48) : A2($List._op["::"],
                  _U.update(_p47,{penaltyCount: _p47.penaltyCount + 1}),
                  _p48);
               } else return A2($List._op["::"],
               _p47,
               A3(clickPeaks,current,start,_p48));
         }
   });
   var update = F2(function (inputSig,_p49) {
      var _p50 = _p49;
      var _p59 = _p50._4;
      var _p58 = _p50._1;
      var _p57 = _p50._0;
      ...
      var _p51 = inputSig;
      switch (_p51.ctor)
      {case "InitData": var _p52 = _p51._0;
           var speed = 0.5 * $Basics.toFloat(_p52.bpm) / 60000.0;
           var line$ = _U.update(_p56,{speed: speed});
           return {ctor: "_Tuple5"
                  ,_0: toPeakObjects(_p52)
                  ,_1: _p58
                  ,_2: line$
                  ,_3: _p52.bpm
                  ,_4: _p52.start};
         case "Click": if (_p51._0._1) {
                 var _p53 = _p57;
                 if (_p53.ctor === "[]") {
                       return {ctor: "_Tuple5"
                              ,_0: _p57
                              ,_1: _U.update(_p58,{penaltyCount: _p58.penaltyCount + 1})
                              ,_2: _p56
                              ,_3: _p55
                              ,_4: _p59};
                    } else {
                       return {ctor: "_Tuple5"
                              ,_0: A3(clickPeaks,_p51._0._0,_p59,_p57)
                              ,_1: _p58
                              ,_2: _p56
                              ,_3: _p55
                              ,_4: _p59};
                    }
              } else return {ctor: "_Tuple5"
                            ,_0: _p57
                            ,_1: _p58
                            ,_2: _p56
                            ,_3: _p55
                            ,_4: _p59};
         default: var line$ = A2(updateLine,_p51._0._1,_p56);
           var _p54 = A2(updatePeaks,
           _p51._0._0,
           {ctor: "_Tuple5",_0: _p57,_1: _p58,_2: _p56,_3: _p55,_4: _p59});
           var ps$ = _p54._0;
           var score$ = _p54._1;
           return {ctor: "_Tuple5"
                  ,_0: ps$
