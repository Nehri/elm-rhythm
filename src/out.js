...
Elm.Main.make = function (_elm) {
   ...
   r) {
      ...
      var w2 = function () {
         ...
         2 * _p10);
         return _U.cmp(mod,
         _p10) < 0 ? (_p10 / -2 | 0) + mod : (_p10 / 2 | 0) - A2($Basics._op["%"],
         mod,
         _p10);
      }();
   ...
   var drawPeaks = F4(function (_p11,curTime,p,line) {
      drawPeaks: while (true) {
         ...
         if (_p13.ctor === "[]") {
               ...
               var _p15 = _p13._1;
               var _p14 = _p13._0;
               if (_U.eq(_p14.clicked,true)) {
                     var _v8 = {ctor: "_Tuple2",_0: _p17,_1: _p16},
                     _v9 = curTime,
                     _v10 = _p15,
                     _v11 = line;
                     _p11 = _v8;
                     ...
                     var timeDistance = _p14.songStart + _p14.timeDelta * 1000 - curTime;
                     if (_U.cmp(timeDistance,-300) < 0) {
                           var _v12 = {ctor: "_Tuple2",_0: _p17,_1: _p16},
                           _v13 = curTime,
                           _v14 = _p15,
                           _v15 = line;
                           _p11 = _v12;
   ...
   var view = F4(function (_p19,rt,peaks,_p18) {
      var _p20 = _p19;
      var _p25 = _p20._0;
      var _p24 = _p20._1;
      var _p21 = _p18;
      var _p23 = _p21._1;
      var _p22 = {ctor: "_Tuple2",_0: _p25 - 100,_1: _p24 - 100};
      var w$ = _p22._0;
      var h$ = _p22._1;
      ...
      linePosition({ctor: "_Tuple2"
                   ,_0: $Basics.toFloat(_p25)
                   ,_1: _p23.height * $Basics.toFloat(h$ / 2 | 0)}),
      A2($List.append,
      A4(drawPeaks,
